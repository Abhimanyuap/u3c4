...
var cont=document.getElementById("box111");
...
function append(data){
    var box12=document.getElementById("detailed_newst");
    ...
    data.forEach(function(el){
        ...
        imag.src=el.urlToImage[index];
        imag.style.width="150px"
        imag.style.height="100%"

        var author=document.createElement("p");
        author.innerText=el.author[index];

        var des=document.createElement("p");
        des.innerText=el.description[index];
